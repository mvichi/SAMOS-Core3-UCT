...
% -------------------------------------------------
\begin{document}
    \title[Core 3 ]{Day 3: Revision control systems and code maintenance}
...
\section{M: Revision Control Systems}
...
\section{M: Hands-on tutorial - GIT and GitHub}
%
...
\item \scriptsize{First, open an account on GitHub and learn how to create a remote repository \href{https://docs.github.com/en/get-started/start-your-journey/creating-an-account-on-github}{https://docs.github.com/en/get-started/start-your-journey/creating-an-account-on-github}}
\end{itemize}
\end{columns}
...
\begin{frame}{Hands-on tutorial}
    \begin{itemize}
    \item \textbf{\texttt{git} and GitHub} with jupyter lab\\  
    \item Objective: learn how to use a RCS to keep track of code changes.
